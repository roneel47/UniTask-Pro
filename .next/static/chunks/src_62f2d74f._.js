(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_62f2d74f._.js", {
...
_s(useLocalStorage, "2kU1/nKKoFCQAPlhdhA0MuFqhd8=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
const AuthProvider = ({ children })=>{
    ...
    const [users, setUsers] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$local$2d$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useLocalStorage"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LOCAL_STORAGE_USERS_KEY"], []);
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"])();
    const initializeMasterAdmin = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuthProvider.useCallback[initializeMasterAdmin]": ()=>{
            const masterAdminExists = users.some({
                "AuthProvider.useCallback[initializeMasterAdmin].masterAdminExists": (user)=>user.usn === __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MASTER_ADMIN_USN"]
            }["AuthProvider.useCallback[initializeMasterAdmin].masterAdminExists"]);
            if (!masterAdminExists) {
                const masterAdmin = {
                    id: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MASTER_ADMIN_USN"],
                    usn: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MASTER_ADMIN_USN"],
                    password: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MASTER_ADMIN_PASSWORD"],
                    role: 'master-admin',
                    semester: 'N/A',
                    name: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MASTER_ADMIN_NAME"]
                };
                setUsers([
                    ...users,
                    masterAdmin
        ...
        "AuthProvider.useEffect": ()=>{
            ...
            if (storedUserJson) {
                ...
                const validatedUser = users.find({
                    "AuthProvider.useEffect.validatedUser": (u)=>u.usn === storedUser.usn
                }["AuthProvider.useEffect.validatedUser"]);
                if (validatedUser) {
...
_s(AuthProvider, "f5pj/uPT4duA8FO/bRT6F8RQRIk=", false, function() {
    return [
...
"[project]/src/hooks/use-auth.ts [app-client] (ecmascript) <locals>": ((__turbopack_context__) => {
"use strict";
...
"[project]/src/hooks/use-auth.ts [app-client] (ecmascript) <module evaluation>": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/src/hooks/use-auth.ts [app-client] (ecmascript) <locals>");
}}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$local$2d$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/hooks/use-local-storage.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/constants.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$auth$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$module__evaluation$3e$__ = __turbopack_context__.i("[project]/src/hooks/use-auth.ts [app-client] (ecmascript) <module evaluation>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$auth$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/contexts/auth-context.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/hooks/use-toast.ts [app-client] (ecmascript)");
...
const DataProvider = ({ children })=>{
    _s();
    const { currentUser } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$auth$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
    const [storedUsers, setStoredUsers] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$local$2d$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useLocalStorage"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LOCAL_STORAGE_USERS_KEY"], []);
    const [storedTasks, setStoredTasks] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$local$2d$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useLocalStorage"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LOCAL_STORAGE_TASKS_KEY"], []);
    const [storedTaskAssignmentsMeta, setStoredTaskAssignmentsMeta] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$local$2d$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useLocalStorage"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LOCAL_STORAGE_TASK_ASSIGNMENTS_META_KEY"], []);
    const [users, setUsers] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(storedUsers);
    const [tasks, setTasks] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(storedTasks);
    const [taskAssignmentsMeta, setTaskAssignmentsMeta] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(storedTaskAssignmentsMeta);
    const [isLoading, setIsLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(true);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DataProvider.useEffect": ()=>setUsers(storedUsers)
    }["DataProvider.useEffect"], [
        storedUsers
    ]);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DataProvider.useEffect": ()=>setTasks(storedTasks)
    }["DataProvider.useEffect"], [
        storedTasks
    ]);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DataProvider.useEffect": ()=>setTaskAssignmentsMeta(storedTaskAssignmentsMeta)
    }["DataProvider.useEffect"], [
    ...
    const fetchTasks = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "DataProvider.useCallback[fetchTasks]": ()=>{
            setIsLoading(true);
                ...
                "DataProvider.useCallback[fetchTasks]": ()=>{
                    ...
                    if (currentUser && currentUser.role === 'student' && currentUser.semester !== 'N/A') {
                        const userTasks = storedTasks.filter({
                            "DataProvider.useCallback[fetchTasks].userTasks": (task)=>task.assignedToUsn === currentUser.usn
                        }["DataProvider.useCallback[fetchTasks].userTasks"]);
                        const semesterWideTasks = storedTasks.filter({
                            "DataProvider.useCallback[fetchTasks].semesterWideTasks": (task)=>task.assignedToSemester === currentUser.semester && task.assignedToUsn === 'all'
                        }["DataProvider.useCallback[fetchTasks].semesterWideTasks"]);
                        semesterWideTasks.forEach({
                            "DataProvider.useCallback[fetchTasks]": (semesterTask)=>{
                                const userAlreadyHasTask = userTasks.some({
                                    "DataProvider.useCallback[fetchTasks].userAlreadyHasTask": (ut)=>ut.title === semesterTask.title && ut.assigningAdminUsn === semesterTask.assigningAdminUsn
                                }["DataProvider.useCallback[fetchTasks].userAlreadyHasTask"]);
                                if (!userAlreadyHasTask) {
                                    ...
                                    setStoredTasks({
                                        "DataProvider.useCallback[fetchTasks]": (prevTasks)=>[
                                                ...prevTasks,
                                                newTaskForUser
                                            ]
                                    }["DataProvider.useCallback[fetchTasks]"]);
            ...
            }["DataProvider.useCallback[fetchTasks]"], 500);
        }
    }["DataProvider.useCallback[fetchTasks]"], [
        currentUser,
        storedTasks,
    ...
    const addTask = async (taskData)=>{
        ...
        const newTasks = [];
        const now = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$formatISO$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatISO"])(new Date());
    ...
    const updateTask = async (taskId, updates)=>{
        ...
        if (updatedTask) (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"])({
            title: "Task Updated",
    ...
    const deleteTask = async (taskId)=>{
        ...
        if (taskToDelete) (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"])({
            title: "Task Deleted",
    ...
    const deleteUser = async (userId)=>{
        ...
        if (userToDelete) (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"])({
            title: "User Deleted",
    ...
    const updateUser = async (userId, updates)=>{
        ...
        if (updatedUser) {
            ...
            if (currentUser?.id === updatedUser.id) {
                const { updateCurrentUser } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$auth$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
                updateCurrentUser(updatedUser);
            }
        }
        return updatedUser;
    };
    const getTasksForCurrentUser = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "DataProvider.useCallback[getTasksForCurrentUser]": ()=>{
            if (!currentUser) return [];
            return tasks.filter({
                "DataProvider.useCallback[getTasksForCurrentUser]": (task)=>task.assignedToUsn === currentUser.usn
            }["DataProvider.useCallback[getTasksForCurrentUser]"]);
        }
    }["DataProvider.useCallback[getTasksForCurrentUser]"], [
        currentUser,
    ...
    const getTasksByAdmin = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "DataProvider.useCallback[getTasksByAdmin]": (adminUsn)=>{
            return tasks.filter({
                "DataProvider.useCallback[getTasksByAdmin]": (task)=>task.assigningAdminUsn === adminUsn
            }["DataProvider.useCallback[getTasksByAdmin]"]);
        }
    }["DataProvider.useCallback[getTasksByAdmin]"], [
        tasks
    ]);
    const getUsersByFilter = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "DataProvider.useCallback[getUsersByFilter]": (role, semester, usnSearch)=>{
            return users.filter({
                "DataProvider.useCallback[getUsersByFilter]": (user)=>{
            ...
            }["DataProvider.useCallback[getUsersByFilter]"]);
        }
    }["DataProvider.useCallback[getUsersByFilter]"], [
        users
    ]);
...
_s(DataProvider, "hX6tCu3/oZ54iU0Rmn9zjhGT4AE=", false, function() {
    return [
...
const useData = ()=>{
    _s1();
    const context = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].useContext(DataContext);
    if (context === undefined) {
...
//# sourceMappingURL=src_62f2d74f._.js.map